...
export const Route = createLazyFileRoute("/_auth/player")({
...
function PlayerPage() {
  ...
  return (
    <div className="flex-1 flex flex-col lg:flex-row bg-white min-h-[calc(100vh-64px)] overflow-hidden">
      {isLoading ? (
      ...
      <div className="w-full lg:w-[450px] xl:w-[500px] h-full lg:h-[calc(100vh-64px)] lg:sticky lg:top-0 shrink-0">
        <PlayerSidebar 
